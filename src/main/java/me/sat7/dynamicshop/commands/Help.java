...
public final class Help {
    ...
    public static void showHelp(String helpcode, Player player, String[] args)
    {
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","main"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","shop"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","openshop"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","addhand"));
        ...
        else if(helpcode.startsWith("add") && player.hasPermission("dshop.admin.shopedit"))
        {
            if(helpcode.length() > "add".length())
            {
                try
                {
                    ItemStack tempItem = new ItemStack(Objects.requireNonNull(Material.getMaterial(args[3])));
                    int idx = ShopUtil.findItemFromShop(args[1], tempItem);
            ...
            {
                player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","add"));
        ...
        else if(helpcode.contains("edit") && !helpcode.equals("editall") && player.hasPermission("dshop.admin.shopedit"))
        {
            if(helpcode.length() > "edit".length())
            {
                try
                {
                    ItemStack tempItem = new ItemStack(Objects.requireNonNull(Material.getMaterial(args[3].substring(args[3].indexOf("/") + 1))));
                    int idx = ShopUtil.findItemFromShop(args[1], tempItem);
            ...
            {
                player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","edit"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","editall"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","cmdHelp"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","createshop"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","§c§ldeleteshop§f§r"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","mergeshop"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","renameshop"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","permission"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","maxpage"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","flag"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","position"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","shophours"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","fluctuation"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","stockStabilizing"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","hideStock"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","hidePricingType"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","account"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","account set"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","account linkto"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","account transfer"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","settax"));
            player.sendMessage(" - " + LangUtil.ccLang.get().getString("HELP.USAGE") + ": /ds settax <value>");

            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","settax temp"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","setdefaultshop"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","§c§ldeleteOldUser§f§r"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","convert"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","sellbuy"));
        ...
        {
            player.sendMessage(DynamicShop.dsPrefix + Objects.requireNonNull(LangUtil.ccLang.get().getString("HELP.TITLE")).replace("{command}","log"));
