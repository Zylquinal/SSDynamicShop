...
public final class DynamicShop extends JavaPlugin implements Listener {
    ...
    private void initCommands() {
        ...
        Objects.requireNonNull(getCommand("DynamicShop")).setExecutor(new Root());
        Objects.requireNonNull(getCommand("shop")).setExecutor(new Optional());

        // 자동완성
        Objects.requireNonNull(getCommand("DynamicShop")).setTabCompleter(this);
