...
public class CustomConfig {
    ...
    public void setup(String name, String folder){
        ...
        file = new File(Objects.requireNonNull(Bukkit.getServer().getPluginManager().getPlugin("DynamicShop")).getDataFolder(), path);
    ...
    {
        file = new File(Objects.requireNonNull(Bukkit.getServer().getPluginManager().getPlugin("DynamicShop")).getDataFolder(), folder+"/"+name + ".yml");
    ...
    {
        File tempFile = new File(Objects.requireNonNull(Bukkit.getServer().getPluginManager().getPlugin("DynamicShop")).getDataFolder(), folder+"/"+name + ".yml");
