...
public class ItemSettings {
    ...
    public Inventory getGui(Player player, int tab, DSItem dsItem) {
        ...
        Inventory inven = Bukkit.createInventory(player,36, Objects.requireNonNull(title));
        ...
        if(tab <= 4)
        {
            setItems(inven, m100Btn, m10Btn, m1Btn, m01Btn, p01Btn, p1Btn, p10Btn, p100Btn);
            if(tab >= 2)
            {
        ...
        {
            setItems(inven, m1000Btn, m100Btn, m10Btn, m1Btn, p1Btn, p10Btn, p100Btn, p1000Btn);
            if(tab == 5)
            {
    ...
    private void setItems(Inventory inven, ItemStack m100Btn, ItemStack m10Btn, ItemStack m1Btn, ItemStack m01Btn, ItemStack p01Btn, ItemStack p1Btn, ItemStack p10Btn, ItemStack p100Btn) {
