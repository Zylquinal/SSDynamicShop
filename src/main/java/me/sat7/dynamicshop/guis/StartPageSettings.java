...
public class StartPageSettings {
    ...
    public Inventory getGui(Player player) {
        ...
        Inventory inven = Bukkit.createInventory(player,9, Objects.requireNonNull(title));
        ...
        ItemStack iconBtn = ItemsUtil.createItemStack(Material.getMaterial(Objects.requireNonNull(StartPage.ccStartPage.get().getString("Buttons." + temp[1] + ".icon"))),null,
